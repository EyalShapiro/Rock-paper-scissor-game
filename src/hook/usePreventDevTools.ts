...
function GetDevUrl() {
   const portListDev: Array<number | string> = [3000, 3001, 3002, 5173, 5174, 8080] as const;
   const isProductionEnvironment = !portListDev.some(port => window.location.href.includes(`http://localhost:${(port)}`));
